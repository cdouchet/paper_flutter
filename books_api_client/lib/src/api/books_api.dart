...
class BooksApi {
  ...
  Future<Response<BuiltList<Book>>> getBooks({
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FullBook] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FullBook>> getFullBook({
    ...
    final _path = r'/books/full/{book_id}'.replaceAll(
        '{' r'book_id' '}',
        encodeQueryParameter(_serializers, bookId, const FullType(String))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FullBook),
            ) as FullBook;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Book>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Book>>> getMyBooks({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<BuiltList<BookWithStats>>> getRecommendedBooks({
    ...
    final _path = r'/books/recommended';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ObjectId>> newBook({
    ...
    try {
      const _type = FullType(NewBook);
      _bodyData = _serializers.serialize(newBook, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Parameters:
  /// * [bookId]
  /// * [body] - The book's new description
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Book>> updateBookDescription({
    required String bookId,
    ...
    final _path = r'/books/{book_id}/description'.replaceAll(
        '{' r'book_id' '}',
        encodeQueryParameter(_serializers, bookId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [Book] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Book>> updateBookTitle({
    required String bookId,
    required String body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/books/{book_id}/title'.replaceAll(
        '{' r'book_id' '}',
        encodeQueryParameter(_serializers, bookId, const FullType(String))
            .toString());
    final _options = Options(
