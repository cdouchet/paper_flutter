...
class BooksApi {
  ...
  Future<Response<String>> updateBookArt({
    ...
    final _path = r'/books/{book_id}/art'.replaceAll(
        '{' r'book_id' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> updateBookCover({
    required String bookId,
    required MultipartFile file,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/books/{book_id}/cover'.replaceAll(
        '{' r'book_id' '}',
        encodeQueryParameter(_serializers, bookId, const FullType(String))
            .toString());
    final _options = Options(
